...
local ADVANCED_AXES = {"BAD PRESIDENT or GOOD PRESIDENT?","BAD SCHOOL or GOOD SCHOOL?","UNREASONABLE PHOBIA or REASONABLE PHOBIA?","BAD CANDY or GOOD CANDY?",
"WON'T LIVE TO 100 or WILL LIVE TO 100?","ILLEGAL or LEGAL?","LEAST POWERFUL GOD or MOST POWERFUL GOD?","UNDERRATED BOOK or OVERRATED BOOK?","WORST CHORE or BEST CHORE?",
"BLUE or GREEN?","NERD or JOCK?","PERSON YOU COULD BEAT UP or PERSON WHO'D BEAT YOU UP?","BAD DISNEY CHARACTER or GOOD DISNEY CHARACTER?","DICTATORSHIP or DEMOCRACY?",
"BAD ADVICE or GOOD ADVICE?","ART or COMMERCE?","INCLUSIVE or EXCLUSIVE?","NOT HUGGABLE or HUGGABLE?","HORIZONTAL or VERTICAL?","HARD TO SIT ON or EASY TO SIT ON?",
"GUILTY PLEASURE or ACTUALLY JUST BAD?","FUNNY TOPIC or SERIOUS TOPIC?","FRUIT or VEGETABLE?","POWERLESS or POWERFUL?","UNSEXY COLOR or SEXY COLOR?","DERIVATIVE or ORIGINAL?",
"UNNATURAL or NATURAL?","UGLY WORD or BEAUTIFUL WORD?","TRUE or FALSE?","THE WORST or THE BEST?","TALENT or SKILL?","STATIONARY or MOBILE?","SOCIALIST or CAPITALIST?",
"SHORT or LONG?","SECRET or PUBLIC KNOWLEDGE?","QUIET or LOUD?","POPULAR or ELITIST?","NOT ART or ART?","MILD or SPICY?","BAD INVESTMENT or GOOD INVESTMENT?","LIMITED or INFINITE?",
"DOG NAME or CAT NAME?","THRILLING or TERRIFYING?","ENDANGERED SPECIES or OVERPOPULATED SPECIES?","CONVENTIONAL WISDOM or FRINGE BELIEF?","BORING PERSON or FUN PERSON?",
"FAMOUS or INFAMOUS?","BAD MOUTHFEEL or GOOD MOUTHFEEL?","NEVER ON TIME or ALWAYS ON TIME?","TRADITIONAL or RADICAL?","UNDERRATED GAME or OVERRATED GAME?",
"DEEP THOUGHT or SHALLOW THOUGHT?","WEIRD or STRANGE?","SCIENCE or PSEUDO-SCIENCE?","LIMP or FIRM?","GOSSIP or NEWS?","NOT ENOUGH or TOO MUCH?","UNSCENTED or SCENTED?",
"HETEROGENOUS or HOMOGENOUS?","BAD DOG BREED or GOOD DOG BREED?","ONE HIT WONDER or POP ICON?","TICK or TOCK?","NORMAL GREETING or WEIRD GREETING?","SIMILAR or IDENTICAL?",
"EXPECTED or UNEXPECTED?","UNSEXY POKÉMON or SEXY POKÉMON?","TOO SMALL or TOO BIG?","WORST YEAR IN HISTORY or BEST YEAR IN HISTORY?","LITTLE KNOWN FACT or WELL KNOWN FACT?",
"LOCAL ISSUE or GLOBAL ISSUE?","WORST ERA TO TIME TRAVEL TO or BEST ERA TO TIME TRAVEL TO?","SMALL NUMBER or LARGE NUMBER?","OLD FASHIONED or AVANT GARDE?","SMALL or TINY?",
"GENUINE PERSON or PHONY PERSON?","ETIQUETTE or MANNERS?","BENEFITS YOU or BENEFITS EVERYONE?","NON-PARTISAN or PARTISAN?","CASUAL EVENT or FORMAL EVENT?","SMALL TALK or HEAVY SUBJECT?",
"RELIGIOUS or SCARILEGIOUS?","ILLEGAL or PROHIBITED?","OUT OF CONTROL or IN CONTROL?","VAPES or DOESN'T VAPE?"}
...
misc.fuseLists(AXES, ADVANCED_AXES)
